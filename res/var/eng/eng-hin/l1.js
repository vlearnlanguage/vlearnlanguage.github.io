...
window[t+"-ti"+k] = "Lets Start!"; //title
window[t+"-msg"+k] = "We can start by learning simple and most used words."; //message
...
window[t+"-o2"+k] = "चाय"; window[t+"-l2-"+k] = "/level1/tea.png"; window[t+"-m2-"+k] = "eng/level1/house.mp3";
window[t+"-o3"+k] = "घर"; window[t+"-l3-"+k] = "/level1/house.png"; window[t+"-m3-"+k] = "eng/level1/house.mp3";
window[t+"-o4"+k] = "गाड़ी"; window[t+"-l4-"+k] = "/level1/car.png"; window[t+"-m4-"+k] = "eng/level1/house.mp3";
window[t+"-ans"+k] = 3;
...
window[t+"-type"+k] = "match";
window[t+"-l"+k] = 5; //how many options are there
window[t+"-o-l-1"+k] = "है"; window[t+"-o-r-1"+k] = "is";
window[t+"-o-l-2"+k] = "पानी"; window[t+"-o-r-2"+k] = "water";
window[t+"-o-l-3"+k] = "बड़ा"; window[t+"-o-r-3"+k] = "big";
...
k++;
window[t+"-type"+k] = "mcq";
window[t+"-q"+k] = "उसका नाम"; window[t+"-m"+k] = null; //m is music
window[t+"-l"+k] = 6; //how many options are there
window[t+"-o1"+k] = "name";
window[t+"-o2"+k] = "his";
window[t+"-o3"+k] = "water";
...
k++;
window[t+"-type"+k] = "mcq";
window[t+"-q"+k] = "उसकी चाय ठंडी है"; window[t+"-m"+k] = null; //m is music
window[t+"-l"+k] = 8; //how many options are there
window[t+"-o1"+k] = "name";
window[t+"-o2"+k] = "tea";
window[t+"-o3"+k] = "her";
...
k++;
window[t+"-type"+k] = "mcq";
window[t+"-q"+k] = "उसका नाम जॉन है"; window[t+"-m"+k] = null; //m is music
window[t+"-l"+k] = 8; //how many options are there
window[t+"-o1"+k] = "name";
window[t+"-o2"+k] = "tea";
window[t+"-o3"+k] = "his";
...
k++;
window[t+"-type"+k] = "word";
window[t+"-q"+k] = "घर"; window[t+"-m"+k] = null; //m is music
window[t+"-o1"+k] = "car";
window[t+"-o2"+k] = "house";
window[t+"-o3"+k] = "is";
window[t+"-o4"+k] = "name";
...
k++;
window[t+"-type"+k] = "word";
window[t+"-q"+k] = "गाड़ी"; window[t+"-m"+k] = null; //m is music
window[t+"-o1"+k] = "is";
window[t+"-o2"+k] = "your";
window[t+"-o3"+k] = "car";
window[t+"-o4"+k] = "name";
...
k++;
window[t+"-type"+k] = "word";
window[t+"-q"+k] = "मेरा"; window[t+"-m"+k] = null; //m is music
window[t+"-o1"+k] = "is";
window[t+"-o2"+k] = "your";
window[t+"-o3"+k] = "car";
window[t+"-o4"+k] = "my";
