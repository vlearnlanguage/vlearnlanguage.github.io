...
window[t+"-ti"+k] = "New words"; //title
window[t+"-msg"+k] = "Lets start to learn some new words about animals."; //message
...
window[t+"-type"+k] = "message";
window[t+"-ti"+k] = "New words"; //title
window[t+"-msg"+k] = "Lets learn numbers from one to ten."; //message
