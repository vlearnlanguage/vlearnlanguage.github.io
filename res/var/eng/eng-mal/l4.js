...
window[t+"-o3"+k] = "അച്ഛൻ"; window[t+"-l3-"+k] = "/level2/father.png";
window[t+"-o4"+k] = "അമ്മ"; window[t+"-l4-"+k] = "/level2/mother.png";
window[t+"-ans"+k] = 4;

k++;
window[t+"-type"+k] = "word";
window[t+"-q"+k] = "അമ്മ"; window[t+"-m"+k] = null; //m is music
...
k++;
window[t+"-type"+k] = "word";
window[t+"-q"+k] = "സഹോദരി"; window[t+"-m"+k] = null; //m is music
window[t+"-o1"+k] = "Mother";
window[t+"-o2"+k] = "Father";
window[t+"-o3"+k] = "Sister";
window[t+"-o4"+k] = "Granddaughter";
...
k++;
window[t+"-type"+k] = "word";
window[t+"-q"+k] = "കൊച്ചുമകൾ"; window[t+"-m"+k] = null; //m is music
window[t+"-o1"+k] = "Mother";
window[t+"-o2"+k] = "Father";
window[t+"-o3"+k] = "Sister";
window[t+"-o4"+k] = "Granddaughter";
...
window[t+"-o1"+k] = "സഹോദരൻ"; window[t+"-l1-"+k] = "/level2/boy.png";
window[t+"-o2"+k] = "സഹോദരി"; window[t+"-l2-"+k] = "/level2/sister.png";
window[t+"-o3"+k] = "മകൾ"; window[t+"-l3-"+k] = "/level2/daughter.png";
window[t+"-o4"+k] = "അമ്മ"; window[t+"-l4-"+k] = "/level2/mother.png";
window[t+"-ans"+k] = 3;
...
window[t+"-l"+k] = 6; //how many options are there
window[t+"-o-l-1"+k] = "കൊച്ചുമകൾ"; window[t+"-o-r-1"+k] = "Granddaughter";
window[t+"-o-l-2"+k] = "സഹോദരി"; window[t+"-o-r-2"+k] = "Sister";
window[t+"-o-l-3"+k] = "അമ്മ"; window[t+"-o-r-3"+k] = "Mother";
window[t+"-o-l-4"+k] = "അച്ഛൻ"; window[t+"-o-r-4"+k] = "Father";
window[t+"-o-l-5"+k] = "സഹോദരൻ"; window[t+"-o-r-5"+k] = "brother";
window[t+"-o-l-6"+k] = "മകൾ"; window[t+"-o-r-6"+k] = "daughter";
...
k++;
window[t+"-type"+k] = "word";
window[t+"-q"+k] = "ഇത്"; window[t+"-m"+k] = null; //m is music
window[t+"-o1"+k] = "from";
window[t+"-o2"+k] = "a";
window[t+"-o3"+k] = "this";
window[t+"-o4"+k] = "is";
