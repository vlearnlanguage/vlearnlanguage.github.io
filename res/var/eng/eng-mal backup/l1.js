...
window[t+"-o3"+k] = "വീട്"; window[t+"-l3-"+k] = "/level1/house.png";
window[t+"-o4"+k] = "കാർ"; window[t+"-l4-"+k] = "/level1/car.png";
window[t+"-ans"+k] = 3;
...
window[t+"-n"+k] = "Your"; window[t+"-n-m"+k] = "നിൻ്റെ";
window[t+"-l"+k] = 6; //how many options are there
window[t+"-o1"+k] = "വലുത്";
...
window[t+"-q"+k] = "നിൻ്റെ"; window[t+"-m"+k] = null; //m is music
window[t+"-o1"+k] = "your";
window[t+"-o2"+k] = "big";
window[t+"-o3"+k] = "car";
window[t+"-o4"+k] = "tea";
...
window[t+"-n"+k] = null; window[t+"-n-m"+k] = null; //n means new word, n-m means new word's meaning
window[t+"-l"+k] = 6; //how many options are there
window[t+"-o1"+k] = "ചായ";
...
k++;
window[t+"-type"+k] = "mcq";
window[t+"-q"+k] = "അവളുടെ പേര്"; window[t+"-m"+k] = null; //m is music
window[t+"-l"+k] = 6; //how many options are there
window[t+"-o1"+k] = "name";
window[t+"-o2"+k] = "her";
window[t+"-o3"+k] = "water";
...
k++;
window[t+"-type"+k] = "mcq";
window[t+"-q"+k] = "അവൻ്റെ ചായ തണുപ്പ് ആണ്"; window[t+"-m"+k] = null; //m is music
window[t+"-l"+k] = 8; //how many options are there
window[t+"-o1"+k] = "name";
window[t+"-o2"+k] = "tea";
window[t+"-o3"+k] = "his";
